...
| C4 | Target click lands a grab **or** the deep link on the clipboard | ⚠️ **INTERMITTENT (2/6 attempts, of which the clipboard route is 2/4)** | 16:51 ✓ + 16:54 ✓ (clipboard route), then 17:02 ✗ (`CHAIN_CLIPBOARD got=null`, D-e), 17:04 ✗ (`CHAIN_NO_TARGET`, D-f), 17:05 IG ✗ (`CHAIN_CHOOSER_NO_DOWNI`, no fallback, D-f), 17:12 ✗ (clipboard `got=null` again, D-e). Morning's 8/8 was the clipboard route **plus** the chooser click double-firing (D-a), not reliability. Real files did land at 16:34/16:35 |
